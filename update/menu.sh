...
echo -e "  ${COLOR1}[06]${NC} • [${YELLOW}Menu${NC}] SLOWDNS   ${COLOR1}[14]${NC} • RENEW CERT       $COLOR1 $NC"
...
06 | 6) clear ; slowdns ;;
07 | 7) clear ; gotop ;;
08 | 8) clear ; wget https://raw.githubusercontent.com/myridwan/multi-ws/ipuk/update/update.sh && chmod +x update.sh && ./update.sh ;;
